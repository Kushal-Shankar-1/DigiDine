...
VALUES (1, 25, 'street', 123, 'State'),
       (2, 45, 'street new', 123, 'State new'),
       (3, 58, 'Cedar Avenue', 456, 'New York'),
       (4, 69, 'Elm Avenue', 567, 'Florida'),
       (5, 72, 'Oak Street', 890, 'California'),
       (6, 25, 'Maple Street', 123, 'Arizona'),
       (7, 21, 'Chestnut Avenue', 567, 'Washington'),
       (8, 34, 'Pine Street', 890, 'Oregon'),
       (9, 47, 'Elm Street', 234, 'Texas'),
       (10, 10, 'Oak Avenue', 567, 'Florida'),
       (11, 63, 'Maple Avenue', 890, 'California'),
       (12, 56, 'Cedar Street', 123, 'Arizona'),
       (13, 89, 'Sycamore Avenue', 456, 'New York'),
       (14, 74, 'Willow Street', 789, 'Colorado'),
       (15, 35, 'Walnut Avenue', 234, 'Montana'),
       (16, 92, 'Birch Street', 567, 'Michigan'),
       (17, 28, 'Hickory Avenue', 890, 'New Jersey'),
       (18, 51, 'Cherry Street', 123, 'Ohio'),
       (19, 76, 'Spruce Avenue', 456, 'Washington'),
       (20, 83, 'Chestnut Street', 789, 'Oregon'),
       (21, 44, 'Pine Avenue', 234, 'Texas');
/*!40000 ALTER TABLE `address`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `chef`
    DISABLE KEYS */;
INSERT INTO `chef`
VALUES ('chef', 'chef', 'name', 'password', 1, 'chef@gmail.com'),
       ('chef10', 'Michael', 'Rodriguez', 'michaelpass', 13, 'michaelchef@gmail.com'),
       ('chef11', 'Emma', 'Martinez', 'emmapass', 14, 'emmachef@gmail.com'),
       ('chef12', 'Ethan', 'Hernandez', 'ethanpass', 15, 'ethanchef@gmail.com'),
       ('chef13', 'Isabella', 'Lopez', 'isabellapass', 16, 'isabellachef@gmail.com'),
       ('chef14', 'Mia', 'Gonzalez', 'miaapass', 17, 'miachef@gmail.com'),
       ('chef15', 'James', 'Wilson', 'jamespass', 18, 'jameschef@gmail.com'),
       ('chef16', 'Alexander', 'Anderson', 'alexpass', 19, 'alexchef@gmail.com'),
       ('chef17', 'Grace', 'Taylor', 'gracepass', 20, 'gracechef@gmail.com'),
       ('chef18', 'Charlotte', 'Moore', 'charlottepass', 10, 'charlottechef@gmail.com'),
       ('chef19', 'Daniel', 'Jackson', 'danielpass2', 2, 'danielchef2@gmail.com'),
       ('chef2', 'James', 'Bond', 'password2', 6, 'bondchef@gmail.com'),
       ('chef20', 'William', 'White', 'williampass', 20, 'williamchef@gmail.com'),
       ('chef3', 'Alice', 'Smith', 'alicepass', 6, 'alicechef@gmail.com'),
       ('chef4', 'David', 'Johnson', 'davidpass', 7, 'davidchef@gmail.com'),
       ('chef5', 'Sophia', 'Williams', 'sophiapass', 8, 'sophiachef@gmail.com'),
       ('chef6', 'Robert', 'Brown', 'robertpass', 9, 'robertchef@gmail.com'),
       ('chef7', 'Olivia', 'Miller', 'oliviapass', 10, 'oliviachef@gmail.com'),
       ('chef8', 'Daniel', 'Davis', 'danielpass', 11, 'danielchef@gmail.com'),
       ('chef9', 'Emily', 'Garcia', 'emilypass', 12, 'emilychef@gmail.com');
/*!40000 ALTER TABLE `chef`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `dietary_restriction`
    DISABLE KEYS */;
INSERT INTO `dietary_restriction`
VALUES ('Alkaline', 'Emphasizes alkaline foods and avoids acidic ones'),
       ('Anti-inflammatory', 'Focuses on reducing inflammation in the body'),
       ('Carnivore', 'Primarily meat-based diet'),
       ('Dairy Free', 'Avoids any dairy products'),
       ('DASH', 'Dietary Approaches to Stop Hypertension'),
       ('Flexitarian', 'Mostly vegetarian with occasional meat'),
       ('Fruitarian', 'Mainly consists of fruits'),
       ('GAPS', 'Gut and Psychology Syndrome diet'),
       ('Gluten free', 'User does not want gluten in his food'),
       ('Halal', 'Dietary guidelines followed by Muslims.'),
       ('Intermittent Fasting', 'Cycle between periods of eating and fasting'),
       ('Ketogenic', 'High-fat, low-carb diet'),
       ('Kosher', 'Dietary laws followed by Jewish individuals'),
       ('Lactose free', 'User is lactose intolerant'),
       ('Low Carb', 'Limits intake of carbohydrates'),
       ('Low FODMAP', 'Limits specific carbohydrates'),
       ('Mediterranean', 'Diet inspired by traditional foods of Mediterranean countries'),
       ('Nut allergy', 'User is allergic to nuts.'),
       ('Pegan', 'Combines aspects of paleo and vegan diets'),
       ('Raw Food', 'Primarily uncooked and unprocessed foods'),
       ('Soy free', 'User wants to exclude soy based products'),
       ('Specific Carbohydrate Diet', 'Eliminates certain carbohydrates'),
       ('Sugar Free', 'Eliminates added sugars'),
       ('Vegan', 'User only eats vegan food'),
       ('Volumetrics', 'Focuses on feeling full on fewer calories'),
       ('Weight Watchers', 'Focuses on portion control and balanced diet'),
...
/*!40000 ALTER TABLE `fridge_contains_ingredients`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `fridge_contains_ingredients`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `ingredient`
    DISABLE KEYS */;
INSERT INTO `ingredient`
VALUES ('baking powder', 5, 30, 30, 40),
       ('basil', 5, 2, 3, 95),
       ('bread', 150, 15, 40, 45),
       ('cardamom', 4, 3, 3, 94),
       ('cayenne', 9, 14, 10, 76),
       ('cheese', 150, 15, 40, 45),
       ('chicken', 100, 50, 30, 20),
       ('cinnamon', 6, 9, 7, 84),
       ('cocoa powder', 30, 14, 63, 23),
       ('coriander', 5, 8, 5, 87),
       ('cucumber', 10, 15, 10, 75),
       ('curd', 150, 15, 45, 40),
       ('eggs', 70, 63, 7, 30),
       ('feta cheese', 200, 7, 3, 90),
       ('filling', 120, 7, 43, 50),
       ('flour', 120, 2, 67, 31),
       ('garlic', 10, 5, 5, 90),
       ('ginger', 8, 5, 18, 77),
       ('ground beef', 250, 16, 1, 83),
       ('lemon', 5, 1, 3, 96),
       ('lettuce', 15, 3, 87, 10),
       ('milk', 150, 15, 40, 45),
       ('mint', 150, 15, 40, 45),
       ('mozzarella cheese', 280, 20, 1, 79),
       ('mustard seed', 4, 6, 4, 90),
       ('nori', 50, 4, 86, 10),
       ('nutmeg', 4, 3, 3, 94),
       ('olive oil', 120, 20, 10, 70),
       ('onion', 150, 15, 45, 40),
       ('oregano', 3, 2, 5, 93),
       ('paprika', 5, 3, 10, 87),
       ('parsley', 5, 8, 5, 87),
       ('pasta', 200, 5, 75, 20),
       ('peanut butter', 150, 15, 40, 45),
       ('pineapple', 20, 30, 15, 55),
       ('potato', 100, 50, 30, 20),
       ('ricotta cheese', 300, 15, 8, 77),
       ('rosemary', 4, 2, 8, 90),
       ('salsa', 50, 4, 90, 6),
       ('spinach', 15, 25, 15, 60),
       ('sugar', 50, 70, 10, 20),
       ('sushi rice', 220, 2, 43, 55),
       ('taco seasoning', 30, 8, 80, 12),
       ('thyme', 3, 1, 2, 97),
       ('tomato', 150, 15, 40, 45),
       ('tomato sauce', 100, 2, 90, 8),
       ('tortillas', 150, 5, 47, 48),
       ('turmeric', 7, 10, 7, 83);
/*!40000 ALTER TABLE `ingredient`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `ingredient_has_restriction`
    DISABLE KEYS */;
INSERT INTO `ingredient_has_restriction`
VALUES ('bread', 'Gluten free'),
       ('flour', 'Gluten free'),
       ('pasta', 'Gluten free'),
       ('sushi rice', 'Gluten free'),
...
/*!40000 ALTER TABLE `recipe`
    DISABLE KEYS */;
INSERT INTO `recipe`
VALUES (1, 'https://source.unsplash.com/random?burger', 'Burger', NULL, 'chef'),
       (2,
        'https://images.unsplash.com/photo-1555949258-eb67b1ef0ceb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxfDB8MXxyYW5kb218MHx8cGFzdGF8fHx8fHwxNzAxOTY4NjI5&ixlib=rb-4.0.3&q=80&utm_campaign=api-credit&utm_medium=referral&utm_source=unsplash_source&w=1080',
        'Pasta', NULL, 'chef'),
       (3, 'https://source.unsplash.com/random?grilledcheese', 'Grilled cheese', NULL, 'chef'),
       (4, 'https://source.unsplash.com/random?mashed-potato', 'Mashed potato', NULL, 'chef'),
       (5, 'https://source.unsplash.com/random?pbj', 'Peanut butter sandwich', NULL, 'chef'),
       (6, NULL, 'Pizza', NULL, 'chef'),
       (21, 'https://source.unsplash.com/random?lasagna', 'Lasagna', 'Classic Italian Dish', 'chef2'),
       (22, 'https://source.unsplash.com/random?sushi', 'Sushi', 'Japanese Delicacy', 'chef2'),
       (23, 'https://source.unsplash.com/random?tacos', 'Tacos', 'Mexican Flavor', 'chef3'),
       (24, 'https://source.unsplash.com/random?cake', 'Chocolate Cake', 'Decadent Dessert', 'chef4'),
       (25, 'https://source.unsplash.com/random?salad', 'Greek Salad', 'Healthy and Fresh', 'chef5');
/*!40000 ALTER TABLE `recipe`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `recipe_contains_ingredients`
    DISABLE KEYS */;
INSERT INTO `recipe_contains_ingredients`
VALUES (24, 'baking powder'),
       (1, 'bread'),
       (3, 'bread'),
       (5, 'bread'),
       (1, 'cheese'),
...
/*!40000 ALTER TABLE `recipe_cooking_instructions`
    DISABLE KEYS */;
INSERT INTO `recipe_cooking_instructions`
VALUES (1, 1, 'Grill the burger'),
       (1, 2, 'Add sauce'),
       (1, 3, 'Put it on a bun'),
       (2, 1, 'Boil the pasta '),
       (2, 2, 'Add sauce'),
       (3, 1, 'Add bread and cheese'),
       (3, 2, 'Grill '),
       (4, 1, 'mash the potato'),
       (4, 2, 'add milk to it'),
       (6, 1, 'Bake it better'),
       (21, 1, 'Preheat the oven to 375°F'),
       (21, 2, 'Spread a layer of meat sauce in the baking dish'),
       (21, 3, 'Place a layer of lasagna noodles over the sauce'),
       (21, 4, 'Spread a layer of ricotta cheese mixture over the noodles'),
       (21, 5, 'Repeat layers until dish is full'),
       (21, 6, 'End layers with a layer of mozzarella cheese'),
       (21, 7, 'Bake in the preheated oven until bubbly and heated through'),
       (22, 1, 'Cook sushi rice according to package instructions'),
       (22, 2, 'Lay a sheet of nori on a bamboo rolling mat'),
       (22, 3, 'Spread a thin layer of rice on the nori'),
       (22, 4, 'Add filling, and roll tightly'),
       (22, 5, 'Cut the roll into bite-sized pieces'),
       (23, 1, 'Cook ground beef with taco seasoning'),
       (23, 2, 'Warm tortillas and fill with beef, cheese, lettuce, and salsa'),
       (23, 3, 'Serve with desired toppings like guacamole or sour cream'),
       (24, 1, 'Preheat oven to 350°F and grease cake pans'),
       (24, 2, 'Mix dry ingredients and wet ingredients separately'),
       (24, 3, 'Combine and pour batter into cake pans'),
       (24, 4, 'Bake for 30-35 minutes or until a toothpick comes out clean'),
       (25, 1, 'Chop fresh vegetables and mix in a large bowl'),
       (25, 2, 'Drizzle with olive oil and sprinkle with feta cheese and olives');
/*!40000 ALTER TABLE `recipe_cooking_instructions`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `recipe_has_flavour`
    DISABLE KEYS */;
...
VALUES (1, 'restaurant1', 'Indian', 1),
       (2, 'restaurant2', 'Chinese', 2),
       (6, 'restaurant6', 'Mexican', 5),
       (7, 'restaurant7', 'Indian', 6),
       (8, 'restaurant8', 'Mediterranean', 7),
       (9, 'restaurant9', 'Vegetarian', 8),
       (10, 'restaurant10', 'Barbecue', 9),
       (11, 'restaurant11', 'Sushi', 10),
       (12, 'restaurant12', 'Steakhouse', 11),
       (13, 'restaurant13', 'Bakery', 12),
       (14, 'restaurant14', 'Seafood', 13),
       (15, 'restaurant15', 'Chinese', 14),
       (16, 'restaurant16', 'American', 15),
       (17, 'restaurant17', 'French', 16),
       (18, 'restaurant18', 'Thai', 17),
       (19, 'restaurant19', 'Greek', 18),
       (20, 'restaurant20', 'Japanese', 19);
/*!40000 ALTER TABLE `restaurant`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `user`
    DISABLE KEYS */;
INSERT INTO `user`
VALUES ('user', 0, 'user', 'name', 'username@gmail.com', 'password'),
       ('user1', 1, 'Alice', 'Smith', 'alice@example.com', 'alicepass'),
       ('user10', 10, 'Jack', 'Taylor', 'jack@example.com', 'jackpass'),
       ('user11', 11, 'Kate', 'Anderson', 'kate@example.com', 'katepass'),
       ('user12', 12, 'Liam', 'Thomas', 'liam@example.com', 'liampass'),
       ('user13', 13, 'Mia', 'Jackson', 'mia@example.com', 'miaapass'),
       ('user14', 14, 'Noah', 'White', 'noah@example.com', 'noahpass'),
       ('user15', 15, 'Olivia', 'Martinez', 'olivia@example.com', 'oliviapass'),
       ('user16', 16, 'Peter', 'Harris', 'peter@example.com', 'peterpass'),
       ('user17', 17, 'Quinn', 'Clark', 'quinn@example.com', 'quinnpass'),
       ('user18', 18, 'Rachel', 'Lewis', 'rachel@example.com', 'rachelpass'),
       ('user19', 19, 'Samuel', 'Lee', 'samuel@example.com', 'samuelpass'),
       ('user2', 2, 'Bob', 'Johnson', 'bob@example.com', 'bobbypass'),
       ('user20', 20, 'Taylor', 'Adams', 'taylor@example.com', 'taylorpass'),
       ('user3', 3, 'Charlie', 'Williams', 'charlie@example.com', 'charliepass'),
       ('user4', 4, 'David', 'Brown', 'david@example.com', 'davidpass'),
       ('user5', 5, 'Emma', 'Jones', 'emma@example.com', 'emmapass'),
       ('user6', 6, 'Frank', 'Davis', 'frank@example.com', 'frankpass'),
       ('user7', 7, 'Grace', 'Miller', 'grace@example.com', 'gracepass'),
       ('user8', 8, 'Henry', 'Wilson', 'henry@example.com', 'henrypass'),
...
/*!40000 ALTER TABLE `user_has_flavour_pref`
    DISABLE KEYS */;
...
/*!40000 ALTER TABLE `user_has_restriction`
    DISABLE KEYS */;
INSERT INTO `user_has_restriction`
VALUES ('user', 'Alkaline'),
       ('user', 'Anti-inflammatory'),
       ('user', 'Carnivore'),
       ('user', 'Dairy Free'),
       ('user', 'DASH'),
       ('user', 'Flexitarian'),
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `add_cooking_instruction`(IN recipe_id_p INT, IN instruction VARCHAR(64))
BEGIN
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `add_dietary_restriction`(IN user_name_p VARCHAR(64), IN restriction VARCHAR(64))
BEGIN
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `add_recipe`(IN dish_name_p VARCHAR(64), IN user_name_p VARCHAR(64))
BEGIN
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `add_recipe_flavour`(IN recipe_p INT, IN flavour_p VARCHAR(64))
BEGIN
    DECLARE req BOOLEAN;
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `add_recipe_ingredient`(IN recipe_p INT, IN ingredient VARCHAR(64))
BEGIN
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `all_recipes_with_fridge_ingredients`(IN user_name_p VARCHAR(64))
BEGIN
    SELECT *
    FROM recipe r
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `edit_cooking_instruction`(IN recipe_id_p INT, IN step_number_p INT, IN instruction VARCHAR(64))
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */;
/*!50003 SET collation_connection = @saved_col_connection */;
/*!50003 DROP PROCEDURE IF EXISTS `GetChefRecipeCount` */;
/*!50003 SET @saved_cs_client = @@character_set_client */;
/*!50003 SET @saved_cs_results = @@character_set_results */;
/*!50003 SET @saved_col_connection = @@collation_connection */;
/*!50003 SET character_set_client = utf8mb4 */;
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `GetChefRecipeCount`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */;
/*!50003 SET collation_connection = @saved_col_connection */;
/*!50003 DROP PROCEDURE IF EXISTS `GetIngredientDietaryRestrictions` */;
/*!50003 SET @saved_cs_client = @@character_set_client */;
/*!50003 SET @saved_cs_results = @@character_set_results */;
/*!50003 SET @saved_col_connection = @@collation_connection */;
/*!50003 SET character_set_client = utf8mb4 */;
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `GetIngredientDietaryRestrictions`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */;
/*!50003 SET collation_connection = @saved_col_connection */;
/*!50003 DROP PROCEDURE IF EXISTS `GetIngredientDistributionInFridges` */;
/*!50003 SET @saved_cs_client = @@character_set_client */;
/*!50003 SET @saved_cs_results = @@character_set_results */;
/*!50003 SET @saved_col_connection = @@collation_connection */;
/*!50003 SET character_set_client = utf8mb4 */;
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `GetIngredientDistributionInFridges`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */;
/*!50003 SET collation_connection = @saved_col_connection */;
/*!50003 DROP PROCEDURE IF EXISTS `GetRecipeFlavourDistribution` */;
/*!50003 SET @saved_cs_client = @@character_set_client */;
/*!50003 SET @saved_cs_results = @@character_set_results */;
/*!50003 SET @saved_col_connection = @@collation_connection */;
/*!50003 SET character_set_client = utf8mb4 */;
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `GetRecipeFlavourDistribution`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */;
/*!50003 SET collation_connection = @saved_col_connection */;
/*!50003 DROP PROCEDURE IF EXISTS `GetUserDietaryRestrictions` */;
/*!50003 SET @saved_cs_client = @@character_set_client */;
/*!50003 SET @saved_cs_results = @@character_set_results */;
/*!50003 SET @saved_col_connection = @@collation_connection */;
/*!50003 SET character_set_client = utf8mb4 */;
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `GetUserDietaryRestrictions`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */;
/*!50003 SET collation_connection = @saved_col_connection */;
/*!50003 DROP PROCEDURE IF EXISTS `GetUserFlavourPreferences` */;
/*!50003 SET @saved_cs_client = @@character_set_client */;
/*!50003 SET @saved_cs_results = @@character_set_results */;
/*!50003 SET @saved_col_connection = @@collation_connection */;
/*!50003 SET character_set_client = utf8mb4 */;
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `GetUserFlavourPreferences`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */;
/*!50003 SET collation_connection = @saved_col_connection */;
/*!50003 DROP PROCEDURE IF EXISTS `GetUserFridgeColorDistribution` */;
/*!50003 SET @saved_cs_client = @@character_set_client */;
/*!50003 SET @saved_cs_results = @@character_set_results */;
/*!50003 SET @saved_col_connection = @@collation_connection */;
/*!50003 SET character_set_client = utf8mb4 */;
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `GetUserFridgeColorDistribution`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */;
/*!50003 SET collation_connection = @saved_col_connection */;
/*!50003 DROP PROCEDURE IF EXISTS `GetUserIngredientCaloricIntake` */;
/*!50003 SET @saved_cs_client = @@character_set_client */;
/*!50003 SET @saved_cs_results = @@character_set_results */;
/*!50003 SET @saved_col_connection = @@collation_connection */;
/*!50003 SET character_set_client = utf8mb4 */;
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `GetUserIngredientCaloricIntake`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */;
/*!50003 SET collation_connection = @saved_col_connection */;
/*!50003 DROP PROCEDURE IF EXISTS `GetUserIngredientPreferences` */;
/*!50003 SET @saved_cs_client = @@character_set_client */;
/*!50003 SET @saved_cs_results = @@character_set_results */;
/*!50003 SET @saved_col_connection = @@collation_connection */;
/*!50003 SET character_set_client = utf8mb4 */;
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `GetUserIngredientPreferences`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */;
/*!50003 SET collation_connection = @saved_col_connection */;
/*!50003 DROP PROCEDURE IF EXISTS `GetUserIngredientPreferencesHeatmap` */;
/*!50003 SET @saved_cs_client = @@character_set_client */;
/*!50003 SET @saved_cs_results = @@character_set_results */;
/*!50003 SET @saved_col_connection = @@collation_connection */;
/*!50003 SET character_set_client = utf8mb4 */;
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `GetUserIngredientPreferencesHeatmap`()
BEGIN
    SELECT u.user_name, i.ingredient_name
    FROM user_has_flavour_pref ufp
             JOIN user u ON ufp.user = u.user_name
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `get_all_recipes`()
BEGIN
    SELECT * from recipe;
END ;;
DELIMITER ;
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `get_all_restaurant`()
BEGIN
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `get_chef_recipe`(IN user_name_p VARCHAR(64))
BEGIN
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `get_custom_recipes`(IN user_name_p VARCHAR(64))
BEGIN
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `get_flavour_for_recipe`(IN recipe_id_p INT)
BEGIN
    SELECT flavour_name, recipe IS NOT NULL AS is_present
    FROM flavour
             LEFT OUTER JOIN (SELECT * FROM recipe_has_flavour WHERE recipe = recipe_id_p) ri ON flavour = flavour_name;
END ;;
DELIMITER ;
/*!50003 SET sql_mode = @saved_sql_mode */;
/*!50003 SET character_set_client = @saved_cs_client */;
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `get_fridge_ingredient`(
    IN fridge_id_p INT
)
BEGIN
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `get_ingredients_for_recipe`(IN recipe_id_p INT)
BEGIN
    SELECT ingredient_name, recipe IS NOT NULL AS is_present
    FROM ingredient
             LEFT OUTER JOIN (SELECT * FROM recipe_contains_ingredients WHERE recipe = recipe_id_p) ri
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `get_recipe_information`(IN recipe_id_p INT)
BEGIN
    SELECT *
    FROM recipe
    WHERE recipe_id = recipe_id_p;
END ;;
DELIMITER ;
/*!50003 SET sql_mode = @saved_sql_mode */;
/*!50003 SET character_set_client = @saved_cs_client */;
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `get_recipe_instructions`(IN recipe_id INT)
BEGIN
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `get_restaurants`()
BEGIN
    SELECT * FROM restaurant;
END ;;
DELIMITER ;
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `get_restriction_for_recipe`(IN recipe_id INT)
BEGIN
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `get_user_dietary_restrictions`(
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `get_user_flavour`(
    IN user_name VARCHAR(64)
)
BEGIN
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `login_user`(
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `preferred_recipes_with_fridge_ingredients`(IN user_name_p VARCHAR(64))
BEGIN
    SELECT *
                                                    ...
                                                    WHERE NOT EXISTS(SELECT *
                                                                     ...
                                                                     WHERE diet = restrict_name
                                                                       AND ingredient = ANY (SELECT ingredient
                                                                                             ...
                                                                                             WHERE recipe = r.recipe_id))))) diet_recipes
          WHERE
              recipe_id = SOME ( #Merge all recipes that satisfies user dietary restriction AND user flavor preferences
                  SELECT recipe_id
                  FROM recipe
                  WHERE NOT EXISTS(SELECT * FROM user_has_flavour_pref WHERE user = user_name_p) #If no flavor preference, take all recipes
                  UNION
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `register_chef`(
    IN user_name_p VARCHAR(64),
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `remove_cooking_instruction`(IN recipe_id_p INT)
BEGIN
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `remove_dietary_restriction`(IN user_name_p VARCHAR(64), IN restriction VARCHAR(64))
BEGIN
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `remove_recipe`(IN recipe_p INT)
BEGIN
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `remove_recipe_flavour`(IN recipe_p INT, IN flavour_p VARCHAR(64))
BEGIN
    DECLARE req BOOLEAN;
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `remove_recipe_ingredient`(IN recipe_p INT, IN ingredient_p VARCHAR(64))
BEGIN
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `set_fridge_ingredient`(
    IN fridge_id INT,
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `set_user_dietary_restrictions`(
    IN user_name VARCHAR(64),
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `set_user_flavour`(
    IN user_name VARCHAR(64),
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `update_chef_restaurant`(IN user_name_p VARCHAR(64), IN restaurant_p INT)
BEGIN
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `update_email_address`(IN user_name_p VARCHAR(64), IN new_email VARCHAR(64))
BEGIN
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `update_recipe_description`(IN dish_name_p VARCHAR(64),
                                                                       IN user_name_p VARCHAR(64),
...
DELIMITER ;;
CREATE
    DEFINER = `root`@`localhost` PROCEDURE `update_recipe_image`(IN dish_name_p VARCHAR(64), IN user_name_p VARCHAR(64),
                                                                 IN image_link VARCHAR(256))
BEGIN
...
-- Dump completed on 2023-12-08 16:11:05
